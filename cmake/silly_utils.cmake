...
if(NOT EXISTS "${CMAKE_SOURCE_DIR}/su_cmake")
    ...
    FILE(REMOVE_RECURSE "${CMAKE_SOURCE_DIR}/su_cmake")
endif()
...
execute_process(COMMAND ${CMAKE_COMMAND} -E  copy "${SILLY_UTILS_FETCH_ROOT}/silly_utils/cmake/CheckOSEndian.cmake" "${CMAKE_SOURCE_DIR}/su_cmake/CheckOSEndian.cmake")
execute_process(COMMAND ${CMAKE_COMMAND} -E  copy "${SILLY_UTILS_FETCH_ROOT}/silly_utils/cmake/CheckDM8.cmake" "${CMAKE_SOURCE_DIR}/su_cmake/CheckDM8.cmake")
execute_process(COMMAND ${CMAKE_COMMAND} -E  copy "${SILLY_UTILS_FETCH_ROOT}/silly_utils/cmake/CheckEccodes.cmake" "${CMAKE_SOURCE_DIR}/su_cmake/CheckEccodes.cmake")
execute_process(COMMAND ${CMAKE_COMMAND} -E  copy "${SILLY_UTILS_FETCH_ROOT}/silly_utils/cmake/CheckCUDA.cmake" "${CMAKE_SOURCE_DIR}/su_cmake/CheckCUDA.cmake")
