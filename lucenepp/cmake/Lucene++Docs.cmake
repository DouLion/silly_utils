...
IF (ENABLE_DOCS)
    ...
    IF ( DOXYGEN_FOUND )
        ...
        IF ( DOCS_TAGFILE )
            SET ( DOCS_TAGFILE_LOCATION "${PROJECT_BINARY_DIR}/doc/tag/lucenepp.tag"  )
        ENDIF ( DOCS_TAGFILE )
        ...
        IF ( TAR AND GZIP )
            ADD_CUSTOM_TARGET(doc-tarz
                COMMAND "${TAR}" "-czf" "${PROJECT_BINARY_DIR}/doc/lucenepp-doc.tar.gz" ./
	...
	IF ( DOCS_HTML AND NOT WIN32 )
            INSTALL(DIRECTORY "${PROJECT_BINARY_DIR}/doc/html/" DESTINATION share/doc/lucenepp-doc/html)
