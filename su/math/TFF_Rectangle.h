...
template <class Type>
Rectangle<Type>::Rectangle(Type l, Type t, Type r, Type b) : g_left(l), g_top(t), g_right(r), g_bottom(b)
{
...
{
    return ((g_left < other.g_right && other.g_left < g_right) && (g_top < other.g_bottom && other.g_top < g_bottom));
}

template <class Type>
bool Rectangle<Type>::Contain(const Rectangle<Type>& other) const
{
    return ((g_left <= other.g_left && other.g_right <= g_right) && (g_top <= other.g_top && other.g_bottom <= g_bottom));
}
