...
////
//
//#include "silly_spatialite_bak.h"
//#if IS_WIN32
//void silly_spatialite_1::initSpatialite()
//{
//    void* cache = spatialite_alloc_connection();
//    spatialite_init_ex(db, cache, 0);
//}
//
//void silly_spatialite_1::destorySpatialite()
//{
//    spatialite_cleanup_ex(cache);
//}
//
//bool silly_spatialite_1::openDatabase(const char* dbName)
//{
//    int rc;
//    // 打开数据库连接
...
//}
//
//void silly_spatialite_1::closeDatabase()
//{
//    // 关闭数据库连接
//    sqlite3_close(db);
//}
//
//
//bool silly_spatialite_1::createDatabase(const char* dbName)
//{
//    sqlite3* db;
//    int rc;
//    // 打开数据库连接
...
//
//
//bool silly_spatialite_1::insertSpatialData(const char* dbName, gaiaGeomCollPtr geomColl)
//{
//    int rc;
//
//    // //打开数据库连接
...
//
//
//bool silly_spatialite_1::insertSpatialData(const char* dbName, std::vector<gaiaGeomCollPtr> geomColls)
//{
//    // 打开数据库连接
//    sqlite3* db;
...
//
//
//bool silly_spatialite_1::selectSpatialData(const char* dbName, std::vector<gaiaGeomCollPtr>& geomColls)
//{
//    int ret;
//    sqlite3* db;
//    sqlite3_stmt* stmt;
...
//
//
////bool silly_spatialite_1::selectSpatialData(const char* dbName, gaiaGeomCollPtr& geomColl)
////{
////    int ret;
////    sqlite3* handle;
////    sqlite3_stmt* stmt;
...
//
//
//bool silly_spatialite_1_selectSpatialData(const char* dbName, gaiaGeomCollPtr& geomColl)
//{
//    int ret;
//    sqlite3* db;
//    sqlite3_stmt* stmt;
...
//gaiaGeomCollPtr silly_spatialite_1::vectorToPointGeomColl(const std::vector<silly_point>& points)
//{
...
//std::vector<silly_point> silly_spatialite_1::PointgeomCollToVector(const gaiaGeomCollPtr geo)
//{
...
//gaiaGeomCollPtr silly_spatialite_1::sillyLineToGeomColl(const silly_line& line)
//{
...
//gaiaGeomCollPtr silly_spatialite_1::sillyLineToGeomColl(const silly_multi_silly_line& multiLine)
//{
...
//silly_multi_silly_line silly_spatialite_1::geomCollToMultiLine(const gaiaGeomCollPtr& geomColl)
//{
...
//gaiaGeomCollPtr silly_spatialite_1::multiPolyToGeomColl(const silly_multi_poly& multiPoly)
//{
//    gaiaGeomCollPtr geomColl = gaiaAllocGeomColl();
...
//silly_multi_poly silly_spatialite_1::geomCollToMultiPoly(const gaiaGeomCollPtr& geomColl)
//{
...
//
//
////int silly_spatialite_1::creat(std::string spa)
////{
////    // 初始化 Spatialite
////    sqlite3* db;
////    void* cache;
