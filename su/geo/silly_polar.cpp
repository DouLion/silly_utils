...
void silly_polar::normal_to_polar(const double &x0, const double &y0, const double &x, const double &y, double &r,
                                  double &azimuth) {
...
void silly_polar::normal_to_coord(const double &r, const double &azimuth, const double &x0, const double &y0, double &x,
                                 double &y) {
    double pi_angle = azimuth * SILLY_POLAR_PI * 2 / 360.;
    x = r * cos(pi_angle) + x0;
    y = r * sin(pi_angle) + y0;
