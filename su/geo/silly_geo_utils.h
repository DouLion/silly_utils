...
public:
	...
	/// <returns></returns>
	static bool read_geo_coll(const char* file, std::vector<silly_geo_coll>& collection);
	...
	/// <param name="collection"></param>
	/// <returns></returns>
	static bool write_geo_coll(const char* file, const std::vector<silly_geo_coll>& collection);
