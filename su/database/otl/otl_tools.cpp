...
//otl tools::conn_opt_from_json(const Json::Value &root)
//{
//    otl ret;
...
//}
//
//otl_datetime tools::otl_time_from_string(const std::string &str)
//{
//    otl_datetime odt;
...
//}
//
//std::string tools::otl_time_to_string(const otl_datetime &tm)
//{
...
//}
//
//otl tools::conn_opt_from_json(const std::string &json_str)
//{
//    otl ret_opt;
//    Json::Reader reader;
//    Json::Value root;
...
//    {
//        ret_opt = tools::conn_opt_from_json(root);
//    }
//    return ret_opt;
//}
//
//bool tools::conn_opt_from_json(const std::string &str, otl &ret)
//{
//    Json::Value jv_root;
...
//}
//bool tools::conn_opt_from_json(const Json::Value &root, otl &ret)
//{
//    bool status = false;
