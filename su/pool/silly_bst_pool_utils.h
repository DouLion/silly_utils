#ifndef SILLY_THREAD_POOL_UTILS_HPP
#define SILLY_THREAD_POOL_UTILS_HPP
/**
...
#define SILLY_THREAD_POOL_UTILS_VERSION_MAJOR 4
#define SILLY_THREAD_POOL_UTILS_VERSION_MINOR 1
#define SILLY_THREAD_POOL_UTILS_VERSION_PATCH 0
...
class [[nodiscard]] synced_stream
{
  public:
    ...
    /**
     * @brief A stream manipulator to pass to a `synced_stream` (an explicit cast of `std::endl`). Prints a newline character to the stream, and then flushes it. Should only be used if flushing is desired, otherwise a newline character should be used
     * instead.
     */
