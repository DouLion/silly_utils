...
inline bool equal(InputIterator p1, InputIterator p2)
{
...
inline OutputIterator make_vector(InputIterator p1, InputIterator p2, OutputIterator result)
{
    for (unsigned d = 0; d < DIM; ++d)
    {
        *result = *p2 - *p1;
...
*/
template <unsigned DIM, class InputIterator>
inline typename std::iterator_traits<InputIterator>::value_type dot(InputIterator v1, InputIterator v2)
{
...
*/
template <unsigned DIM, class InputIterator, class OutputIterator>
inline OutputIterator interpolate(InputIterator p1, InputIterator p2, float fraction, OutputIterator result)
{
...
inline typename std::iterator_traits<InputIterator1>::value_type point_distance2(InputIterator1 p1, InputIterator2 p2)
{
...
*/
template <unsigned DIM, class InputIterator>
inline typename std::iterator_traits<InputIterator>::value_type line_distance2(InputIterator l1, InputIterator l2, InputIterator p)
{
    typedef typename std::iterator_traits<InputIterator>::value_type value_type;
...
*/
template <unsigned DIM, class InputIterator>
inline typename std::iterator_traits<InputIterator>::value_type segment_distance2(InputIterator s1, InputIterator s2, InputIterator p)
{
    typedef typename std::iterator_traits<InputIterator>::value_type value_type;
...
*/
template <unsigned DIM, class InputIterator>
inline typename std::iterator_traits<InputIterator>::value_type ray_distance2(InputIterator r1, InputIterator r2, InputIterator p)
{
    typedef typename std::iterator_traits<InputIterator>::value_type value_type;
...
inline Statistics compute_statistics(InputIterator first, InputIterator last)
{
    typedef typename std::iterator_traits<InputIterator>::value_type value_type;
...
class PolylineSimplification
{
  ...
  private:
    ...
    */
    inline void CopyKeyAdvance(InputIterator& key, OutputIterator& result)
    {
        for (unsigned d = 0; d < DIM; ++d)
        {
            *result = *key;
    ...
    /*!
        ...
        \param[in,out] result   destination of the copied key
    */
    inline void CopyKey(InputIterator key, OutputIterator& result)
    {
    ...
    */
    inline void Advance(InputIterator& it, diff_type n = 1)
    {
    ...
    */
    inline InputIterator AdvanceCopy(InputIterator it, diff_type n = 1)
    {
        Advance(it, n);
        return it;
    }
