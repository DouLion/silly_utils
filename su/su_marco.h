...
#ifndef SU_MEM_FREE
#define SU_MEM_FREE(p) if(p){free(p);p=nullptr;}
#endif

#ifndef SU_MEM_DEL
#define SU_MEM_DEL(p) if(p){delete p;p = nullptr;}
#endif

#ifndef SUM_MEM_DEL_ARR
#define SUM_MEM_DEL_ARR(p) if(p){delete [] p; p = nullptr;}
#endif
