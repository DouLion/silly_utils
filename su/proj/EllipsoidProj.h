...
public:
	...
	static void CoordinatetoGaussXY_BJ_54(const int& ProjNo, const double& lng, const double& lat, double& gaussX, double& gaussY)
	{
		...
		double M = ELLIPSOID_54_BJ_A * ((1.0 - ELLIPSOID_54_BJ_E2 / 4.0 - 3.0 * ELLIPSOID_54_BJ_E2 * ELLIPSOID_54_BJ_E2 / 64 - 5 * ELLIPSOID_54_BJ_E2 * ELLIPSOID_54_BJ_E2 * ELLIPSOID_54_BJ_E2 / 256.0) * latitude - (3.0 * ELLIPSOID_54_BJ_E2 / 8.0 + 3.0 * ELLIPSOID_54_BJ_E2 * ELLIPSOID_54_BJ_E2 / 32 + 45.0 * ELLIPSOID_54_BJ_E2 * ELLIPSOID_54_BJ_E2 * ELLIPSOID_54_BJ_E2 / 1024.0) * sin(2.0 * latitude) + (15.0 * ELLIPSOID_54_BJ_E2 * ELLIPSOID_54_BJ_E2 / 256.0 + 45.0 * ELLIPSOID_54_BJ_E2 * ELLIPSOID_54_BJ_E2 * ELLIPSOID_54_BJ_E2 / 1024.0) * sin(4.0 * latitude) - (35.0 * ELLIPSOID_54_BJ_E2 * ELLIPSOID_54_BJ_E2 * ELLIPSOID_54_BJ_E2 / 3072.0) * sin(6.0 * latitude));
	...
	static void CoordinatetoGaussXY_WGS_84(const int& ProjNo, const double& lng, const double& lat, double& gaussX, double& gaussY)
	{
		...
		double C = ee * cos(latitude) * cos(latitude);
		double A = (longitude - longitude0) * cos(latitude);
		double M = ELLIPSOID_84_WGS_A * ((1.0 - ELLIPSOID_84_WGS_E2 / 4.0 - 3.0 * ELLIPSOID_84_WGS_E2 * ELLIPSOID_84_WGS_E2 / 64 - 5 * ELLIPSOID_84_WGS_E2 * ELLIPSOID_84_WGS_E2 * ELLIPSOID_84_WGS_E2 / 256.0) * latitude - (3.0 * ELLIPSOID_84_WGS_E2 / 8.0 + 3.0 * ELLIPSOID_84_WGS_E2 * ELLIPSOID_84_WGS_E2 / 32 + 45.0 * ELLIPSOID_84_WGS_E2 * ELLIPSOID_84_WGS_E2 * ELLIPSOID_84_WGS_E2 / 1024.0) * sin(2.0 * latitude) + (15.0 * ELLIPSOID_84_WGS_E2 * ELLIPSOID_84_WGS_E2 / 256.0 + 45.0 * ELLIPSOID_84_WGS_E2 * ELLIPSOID_84_WGS_E2 * ELLIPSOID_84_WGS_E2 / 1024.0) * sin(4.0 * latitude) - (35.0 * ELLIPSOID_84_WGS_E2 * ELLIPSOID_84_WGS_E2 * ELLIPSOID_84_WGS_E2 / 3072.0) * sin(6.0 * latitude));
		gaussX = N * (A + (1 - T + C) * A * A * A / 6 + (5 - 18 * T + T * T + 72 * C - 58 * ee) * A * A * A * A * A / 120);
		gaussY = M + N * tan(latitude) * (A * A / 2 + (5 - T + 9 * C + 4 * C * C) * A * A * A * A / 24 + (61 - 58 * T + T * T + 600 * C - 330 * ee) * A * A * A * A * A * A / 720);
		double X0 = 1000000.0 * (ProjNo + 1) + 500000.0;
		double Y0 = 0;
