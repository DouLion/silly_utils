...
class silly_micaps_utils
{
  public:
    ...
    /// <returns></returns>
    static bool read(const suPath &file, silly_micaps_diamond_4 &md4);
    ...
    /// <param name="md4"></param>
    /// <returns></returns>
    static bool mmap_read(const suPath &file, silly_micaps_diamond_4 &md4);
    ...
    /// <param name="md4"></param>
    /// <returns></returns>
    static bool write(const suPath &file, const silly_micaps_diamond_4 &md4);
