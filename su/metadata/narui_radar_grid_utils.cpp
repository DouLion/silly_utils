...
bool silly_nrd_grid_utils::read(const suPath& file)
{
    bool status = false;
    if (read_header(file))
        ;
...
bool silly_nrd_grid_utils::read_header(const suPath& file)
{
    bool status = false;
    std::ifstream ifs;
...
bool silly_nrd_grid_utils::read_grid(const suPath& file, const double& dst_scale)
{
    bool status = false;
    std::ifstream ifs;
    ifs.open(file, std::ios::out | std::ios::binary);
