...
bool accessor::open(const std::string& root, const silly::file::memory_map::access_mode& mode, bool usemmap)
{
    ...
    //if (silly::file::memory_map::access_mode::Read == mode)  //
    //{
    ...
    //    if (!m_info.open(info_path.c_str(), silly::file::memory_map::access_mode::Read, false))
    //    {
    //        m_info.close();
    //        return false;
    //    }
    ...
    //    if (!m_data.open(data_path.c_str(), silly::file::memory_map::access_mode::Read, usemmap))
    //    {
    //        m_info.close();
...
bool accessor::rebuild_to_v2(const std::string& dst)
{
    //writeopt wo;
    //accessor accv2;
    //accv2.m_root = dst;
    //accv2.m_mode = silly::file::memory_map::access_mode::Write;
    //if (!accv2.open())
    //{
    //    return false;
    //}
    ...
    //accv2.m_data.m_index.m_pack.elayer = 16;
    //accv2.m_data.m_index.m_pack.bound = bound;
    //if (!accv2.m_data.m_index.build())
    //{
    //    return false;
    //}
    ////// data
...
bool accessor::open()
{
    ...
    //if (silly::file::memory_map::access_mode::Read == m_mode)  //
    //{
    //    if (!std::filesystem::exists(info_path) || !std::filesystem::exists(index_path) || !std::filesystem::exists(data_path))
    //    {
    //        m_err = "路径不存在: " + m_root;
    ...
    //    }
    //}
    //else if (silly::file::memory_map::access_mode::Write == m_mode)
    //{
