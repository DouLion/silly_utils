...
class silly_dynamic_rule
{
  public:
    ...
    bool load_code_index(const suPath& file);
    bool save_code_index(const suPath& file);

    bool read_with_code_index(const suPath& file, std::map<std::string, dynamic_rule_record>& records) const;

    bool read_with_code_index(const suPath& file, const std::string& code, dynamic_rule_record& record) const;

    bool write_with_code_index(const suPath& file, const std::map<std::string, dynamic_rule_record>& records) const;
