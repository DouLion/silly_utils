...
#define SU_JSON_HELPER(...)                                                            \
    ...
    bool SUJsonToObject(aigc::JsonHelperPrivate &handle,                               \
    ...
    bool SUObjectToJson(aigc::JsonHelperPrivate &handle,                               \
                          rapidjson::Value &jsonValue,                                   \
...
#define SU_JSON_HELPER_BASE(...)                                           \
    bool SUBaseJsonToObject(aigc::JsonHelperPrivate &handle,               \
                              rapidjson::Value &jsonValue)                   \
    {                                                                        \
        return handle.SetBase(jsonValue, __VA_ARGS__);                       \
    }                                                                        \
    bool SUBaseObjectToJson(aigc::JsonHelperPrivate &handle,               \
                              rapidjson::Value &jsonValue,                   \
                              rapidjson::Document::AllocatorType &allocator) \
    {                                                                        \
