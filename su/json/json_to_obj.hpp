 ...
 * };
 ******************************************************/
#define SU_JSON_HELPER(...)                                                                                                                                           \
    std::map<std::string, std::string> __aigcDefaultValues;                                                                                                           \
    bool SUJsonToObject(aigc::JsonHelperPrivate &handle, rapidjson::Value &jsonValue, std::vector<std::string> &names)                                                \
    {                                                                                                                                                                 \
    ...
    bool SUObjectToJson(aigc::JsonHelperPrivate &handle, rapidjson::Value &jsonValue, rapidjson::Document::AllocatorType &allocator, std::vector<std::string> &names) \
    {                                                                                                                                                                 \
        std::vector<std::string> standardNames = handle.GetMembersNames(#__VA_ARGS__);                                                                                \
        if (names.size() <= standardNames.size())                                                                                                                     \
        {                                                                                                                                                             \
 ...
 *      string B;
 *      SU_JSON_HELPER(A, B)
 *      SU_JSON_HELPER_RENAME("a", "b")
 * };
 ******************************************************/
#define SU_JSON_HELPER_RENAME(...)                                            \
    std::vector<std::string> SURenameMembers(aigc::JsonHelperPrivate &handle) \
    {                                                                         \
 ...
 *      string B;
 *      SU_JSON_HELPER(A, B)
 *      SU_JSON_HELPER_BASE((Base*)this)
 * };
 ******************************************************/
#define SU_JSON_HELPER_BASE(...)                                                                                                         \
    bool SUBaseJsonToObject(aigc::JsonHelperPrivate &handle, rapidjson::Value &jsonValue)                                                \
    {                                                                                                                                    \
        return handle.SetBase(jsonValue, __VA_ARGS__);                                                                                   \
    }                                                                                                                                    \
    bool SUBaseObjectToJson(aigc::JsonHelperPrivate &handle, rapidjson::Value &jsonValue, rapidjson::Document::AllocatorType &allocator) \
    {                                                                                                                                    \
 ...
 *      string name;
 *      int age;
 *      SU_JSON_HELPER(name, age)
 *      SU_JSON_HELPER_DEFAULT(age=18)
 * };
 ******************************************************/
#define SU_JSON_HELPER_DEFAULT(...)                                    \
    void SUDefaultValues(aigc::JsonHelperPrivate &handle)              \
    {                                                                  \
...
class JsonHelperPrivate
{
  ...
  public:
     ...
     *
     * Check Interface
     *      If class or struct add SU_JSON_HELPER\SU_JSON_HELPER_RENAME\SU_JSON_HELPER_BASE,
    ...
    struct HasConverFunction
    {
        ...
        static char func(decltype(&TT::SUJsonToObject));
    ...
    {
        template <typename TT>
        static char func(decltype(&TT::SURenameMembers));
        template <typename TT>
        static int func(...);
        const static bool has = (sizeof(func<T>(NULL)) == sizeof(char));
    };
    ...
    {
        template <typename TT>
        static char func(decltype(&TT::SUBaseJsonToObject));
        template <typename TT>
        static int func(...);
        const static bool has = (sizeof(func<T>(NULL)) == sizeof(char));
    };
    ...
    {
        template <typename TT>
        static char func(decltype(&TT::SUDefaultValues));
        template <typename TT>
        static int func(...);
        const static bool has = (sizeof(func<T>(NULL)) == sizeof(char));
    };
  ...
  public:
    ...
    bool JsonToObject(T &obj, rapidjson::Value &jsonValue)
    {
        ...
        return obj.SUJsonToObject(*this, jsonValue, names);
    }
    ...
    bool ObjectToJson(T &obj, rapidjson::Value &jsonValue, rapidjson::Document::AllocatorType &allocator)
    {
        ...
        if (!BaseConverObjectToJson(obj, jsonValue, allocator))
            return false;
        std::vector<std::string> names = LoadRenameArray(obj);
        return obj.SUObjectToJson(*this, jsonValue, allocator, names);
    }
    ...
    {
        return obj.SURenameMembers(*this);
    }
    ...
    {
        return obj.SUBaseJsonToObject(*this, jsonValue);
    }
    ...
    {
        return obj.SUBaseObjectToJson(*this, jsonValue, allocator);
    }
