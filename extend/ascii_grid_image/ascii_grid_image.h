...
extern "C" {
    ...
    TZX_DLL_EXPORT void convert_hq(double ncols, double nrows, double xllcorner, double yllcorner, double cellsize, double mid, double* data, double* qx, double* qy, char* img_path, bool verbose);
    TZX_DLL_EXPORT unsigned char* get_image_data(double ncols, double nrows, double xllcorner, double yllcorner, double cellsize, double mid, double* hData, double* qxData, double* qyData, int* length, bool verbose);
